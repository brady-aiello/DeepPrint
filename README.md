...
```kotlin
implementation("com.bradyaiello.deepprint:deep-print-reflection:0.4.1")
```
...
plugins {
    ...
    id("com.bradyaiello.deepprint") version "0.4.1"
}
...
dependencies {
    ...
    implementation("com.bradyaiello.deepprint:deep-print-annotations:0.4.1")
    // Where all the DeepPrint code generation logic resides
    implementation("com.bradyaiello.deepprint:deep-print-processor:0.4.1")
    // Run the processor over your main source set
    ksp("com.bradyaiello.deepprint:deep-print-processor:0.4.1")
    ...
    kspTest("com.bradyaiello.deepprint:deep-print-processor:0.4.1")
}
```
